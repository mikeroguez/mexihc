...
### Changed
- Convocatoria del Concurso de Diseño Estudiantil: texto del hito "Fecha límite para camera ready" actualizado a "Envío de notificaciones de evaluación" (Notification of the evaluation process).
...
### Added
- Registro y pago publicados en Tarifas y registro y Primeros pasos: pasos para registrarse, datos bancarios para pagos desde México y enlace al Sistema de Registro.
- Aviso "Registro y pago disponibles" en el postit del inicio, con enlace directo a las instrucciones de pago y tipografía de estilo manuscrito.
- Noticia de apertura de registro y pago agregada a los canales RSS (ES, EN y multilingüe).

### Fixed
- Logo del pie de página que se sobreponía al menú de enlaces en anchos de pantalla entre ~768px y ~1050px.
- Contraste insuficiente (2.79:1) del botón deshabilitado "Formulario pendiente", eliminado al publicarse el registro real.
- Selector de idioma: el idioma activo ahora se anuncia a lectores de pantalla (`aria-current`).
...
### Added
- Entrada de RSS en español, inglés y feed multilingüe anunciando la prórroga del Concurso de Diseño Estudiantil al 30 de agosto de 2026.

### Changed
- Post-it del CTA principal actualizado para destacar la prórroga del Concurso de Diseño Estudiantil y retirar el aviso del Coloquio de Graduados.
- Convocatoria del Concurso de Diseño Estudiantil actualizada con la fecha límite extendida, tanto en página, tabla de convocatorias, navbar e hitos.
- Documentación, paquetes y footer sincronizados con la versión `2026.1.24`.
