...
<template>
	...
	<div>
		<p>To attend the conference, the first step is the payment and registration process. We recommend checking the
			information related to <RouterLink :to="Tr.i18nRoute({ name: 'registration' })" class="uline">{{
						$t("nav.rates_and_registration") }}</RouterLink>,, where you will find details on different rates based
			on
	...
	<img src="/assets/img/quintaDorada.png" width="100%" alt="Facade of Quinta Dorada host hotel">
	...
	<p>
		...
		<iframe
			title="Map of Quinta Dorada host hotel"
	...
	<p>
		<iframe
			title="Map of Central Infoteca conference venue"
	...
	<p>
		<img src="/assets/img/croquis.jpg" width="100%" alt="Campus location map of the conference venue">
	</p>
	...
	<ul>
		...
		<li>
			...
			<img src="/assets/img/taxi.jpg" width="80%" alt="Taxi area at Monterrey airport">
		</li>
	</ul>
