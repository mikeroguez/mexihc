...
<template>
  <section class="calls-catalog" aria-label="Available calls">
    <RouterLink
      v-for="item in calls"
      :key="item.key"
      :to="item.to"
