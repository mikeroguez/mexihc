...
const calls = computed(() => [
  {
    ...
    ...getCallStatus('2026-06-21'),
    iconClass: 'fas fa-file-alt',
    deadlinePrefix: 'Fecha límite para envíos:',
    oldDeadline: '15 de junio de 2026',
    deadline: '21 de junio de 2026',
    deadlineBadge: 'Extendida',
  },
  {
    key: 'cpt',
    title: 'Convocatoria a la sesión de pósteres',
    to: Tr.i18nRoute({ name: 'call-for-posters' }),
    ...getCallStatus('2026-09-13'),
    iconClass: 'fas fa-image',
    deadlinePrefix: 'Fecha límite para envíos:',
    oldDeadline: '6 de septiembre de 2026',
  ...
  },
  {
    ...
    ...getCallStatus('2026-09-06'),
    iconClass: 'fas fa-lightbulb',
    deadlinePrefix: 'Fecha límite para envíos:',
    oldDeadline: '30 de agosto de 2026',
...
<template>
  <section class="calls-catalog" aria-label="Convocatorias disponibles">
    <RouterLink
      v-for="item in calls"
      :key="item.key"
      :to="item.to"
      class="call-card"
    >
      <div class="call-card-icon" aria-hidden="true">
      ...
      <div class="call-card-right">
        <span class="call-card-status" :class="`call-card-status-${item.statusType}`">
          {{ item.statusLabel }}
        </span>
        <span class="call-card-arrow" aria-hidden="true">›</span>
      </div>
    </RouterLink>
  </section>
</template>
