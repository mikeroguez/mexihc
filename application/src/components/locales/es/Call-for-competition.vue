...
<template>
    ...
    <p><strong>Actualización:</strong> la fecha límite de envío se extendió del <del>30 de agosto de 2026</del> al <strong>6 de septiembre de 2026</strong>.</p>
    <ul>
        ...
        <div class="col-md-4">
            <OrganizerItem>
                <template #image>
                    ...
                    <div class="colored-shadow"
                        style="background-image: url(&quot;./assets/img/people/temo.png&quot;);">
                    </div>
                </template>
                <template #name>
